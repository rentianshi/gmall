...
public class AttrGroupController {
    ...
    public ResponseVo<List<AttrGroupEntity>> queryAttrsByCid(@PathVariable("cid")Long cid){
    ...
    public ResponseVo<List<AttrGroupEntity>> queryCategoryById(@PathVariable("cid")Long cid){
